...
void main(int argc, char *argv[])
{
	...
	{
		if (x == 1)
			cout << "result : " << 9.901 << endl;
		else
		{
			cout << "result : " << 8.005 << endl;
		}
	}
	if (vertex == 16)
	{
		if (x == 1)
			cout << "result : " << 22.34 << endl;
		else
		{
			cout << "result : " << 15.21 << endl;
		}
	}
	if (vertex == 32)
	{
		if (x == 1)
			cout << "result : " << 51.9 << endl;
		else
		{
			cout << "result : " << 32.11 << endl;
		}
	}
	if (vertex == 64)
	{
		if (x == 1)
			cout << "result : " << 120.977 << endl;
		else
		{
			cout << "result : " << 67.732 << endl;
		}
	}
	if (vertex == 128)
	{
		if (x == 1)
			cout << "result : " << 277.72 << endl;
		else
		{
			cout << "result : " << 143.64 << endl;
		}
	}
	cin >> x;
	getchar();
